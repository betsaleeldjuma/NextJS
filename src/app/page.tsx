  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-blue-500 to-indigo-100 flex flex-col items-center justify-center p-6'>
      <div className="text-center">
        ...
        <Link className='inline-flex items-centre justify-center bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl' href='/dashboard'>Go to Dashboard</Link>
      </div>
    </div>
  )
}

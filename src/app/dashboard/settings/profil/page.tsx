  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-8'>
      <div className='max-w-4xl mx-auto bg-white rounded-lg shadow-xl p-8'>
        ...
        <section className='mb-8'>
          <h2 className='text-xl font-semibold text-gray-700 mb-4'>Profil Information</h2>
          <div className="space-y-4">
            ...
            <div>
              <label className='block text-sm font-medium text-gray-600'>Email Adress</label>
              <input type="text" defaultValue='john.doe@exemple.com' className='mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500'/>
            </div>
          </div>
        </section>
        {/* Action Settings */}
